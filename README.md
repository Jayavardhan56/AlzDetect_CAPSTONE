...
🔍 Key Features
📤 MRI Upload & Auto‑Preprocessing

Accepts raw brain MRI images of various sizes.

Automatically center‑crops, resizes to 
224
×
224
224×224, converts to RGB, and applies the same preprocessing used during training.
...
git clone https://github.com/your-username/alzheimer-prediction-app.git
cd alzheimer-prediction-app
